...
export const omegaReelScript: ReelCard[] = [
  ...
  { n: 11, category: "Engagement", duration: "40–50s", title: "My First Geometry Box vs Now", hook: "1990s vs 2026 — which one did YOU have? 👇" },
...
export const accdReelScript: ReelCard[] = [
  ...
  { n: 7, category: "Brand Story", duration: "45s", title: "Founders Day — 49 Years of History", hook: "1977. A group of Delhi's cargo professionals had a vision." },
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    gallery: [
      { ratio: "wide", theme: "from-[#050b14] to-[#c9a25a]", label: "ACCD Showcase" },
      { ratio: "square", theme: "from-[#c9a25a] to-[#0a1628]", label: "Brand Identity" },
      { ratio: "square", theme: "from-[#050b14] to-[#0a1628]", label: "Website Detail" },
      { ratio: "wide", theme: "from-[#0a1628] to-[#c9a25a]", label: "Digital Presence" },
      { ratio: "square", theme: "from-[#050b14] to-[#c9a25a]", label: "Brand Visual" },
      { ratio: "square", theme: "from-[#c9a25a] to-[#0a1628]", label: "Website Detail" },
      { ratio: "wide", theme: "from-[#050b14] to-[#0a1628]", label: "Portfolio" },
    ],
    frame: [
      { kind: "nav", brand: "ACCD" },
      {
      ...
      { kind: "marquee", words: ["Annual Convention · 2026", "Industry briefings", "Members-only research", "Policy advocacy"] },
